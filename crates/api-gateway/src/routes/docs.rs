...
use crate::routes::{
    ...
    model_runtime::{
        ModelRuntimeErrorResponse, ModelRuntimeReloadResponse, ModelRuntimeResponse, RuntimeMetricsSummary,
        SlotSummary, SlotViewResponse, StrategyRow,
    },
...
#[openapi(
    ...
    components(
        schemas(
            ...
            objective_core::traits::LatencyHistogram,
            objective_core::traits::ModelSlotState,
            objective_core::traits::ModelSlotTransition,
            objective_core::traits::ModelTimeoutKind,
            RecoveryResponse,
